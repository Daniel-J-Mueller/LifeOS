...
$LD -m elf_i386 -nostdlib -T src/kernel/linker.ld \
    ...
    build/mm.o build/console.o build/shell.o build/cmd.o build/power.o build/string.o build/inventory.o build/sched.o build/driver.o build/keyboard.o build/context_switch.o \
    -o build/kernel.bin
